...
public class DataSetConfig {
    private final Logger log = Logger.getLogger(DataSetConfig.class.getName());

    public DataSetConfig() {
        try {
            Instances data = DataSource.read("/home/firaanki/IdeaProjects/LDS/src/main/resources/dataset.arff");
    ...
    private void saveToFile(Instances data) throws IOException {
        CSVSaver saver = new CSVSaver();
        saver.setInstances(data);
        saver.setFile(new File("/home/firaanki/IdeaProjects/LDS/src/main/resources/dataset.csv"));
        saver.writeBatch();
